...
def main():
    ...
    dt = datetime.now()
    print('Comenzando a crear un objeto Shopkeeper NPC:', dt)
    ...
    dt = datetime.now()
    print('Instanciando ahora traders:', dt)
    for i in range(5):
        shopkeeper = Shopkeeper(180, 22, 5, 8)
        dt = datetime.now()
        print(f'Creando Shopkeeper NPC {i} at:', dt)

    dt = datetime.now()
    print('Finalizó la creación del grupo de traders:', dt)

    dt = datetime.now()
    print('Creando masivamente 10 NPCs:', dt)
    ...
    dt = datetime.now()
    print('Creando 20 anidamientos de objetos clonados:', dt)
    for i in range(20):
        shopkeeper_clone = shopkeeper_template.clone()
        warrior_clone = warrior_template.clone()
        mage_clone = mage_template.clone()
        dt = datetime.now()
        print(f'Finaliza la creación de anidamiento {i} at:', dt)

    dt = datetime.now()
    print('Finalizó la creación de los 20 anidamientos:', dt)
